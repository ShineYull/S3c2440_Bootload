...
/* 此文件draw_circle与draw_line应用接口的实现摘抄于网络博客:
 * 出处：https://blog.csdn.net/p1126500468/article/details/50428613
 * 博客中draw_circle实现的while位置的常量2，在此文件中修改为22. line number in file:34.
 * 画点函数实现位于framebuffer.c，此函数为自己所编。
 */


/*
//-----------画点函数。参数：坐标,颜色-------------------
void fb_put_pixel(int x, int y, int clor)
{
    fb[y*480 + x] = clor;
}
*/
...
void draw_cross(int x, int y, unsigned int color)
{
	/* 显示"+" */
